...
Analysis of Admissions: Inspecting the histogram of admissions shows that the data is right-skewed, also known as positively skewed. the Admissions variable was evaluated to determine whether this skew is caused by outliers or not. Analysis was repeated with outliers removed.
...
county_code <- c("AL", "AG", "NY (Bronx)", "BM", "CA", "CY", "CH", "CM",
                 ...
                 "NY", "RE", "NY (Richmond)", "RO", "SL", "SA", "SC", "SH",
