...
3: Data Preparation
  ...
  3.1: Select Data: Let's remove observations without analyst names, and then maybe a full join and make the TR a variable?
       Or we can just make new data frames for everything we want to do.
